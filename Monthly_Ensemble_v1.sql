...
DROP TABLE IF EXISTS pvt_tst;
CREATE TABLE pvt_tst
AS
SELECT * 
FROM crosstab( 'select fym,rankc, fcst from tst8 order by 1,3') 
     AS pvt_tst(fym VARCHAR(20), X1 float8, X2 float8,X3 float8,X4 float8
