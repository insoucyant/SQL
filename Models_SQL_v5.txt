...
FROM 'D:\Sumit\WORK\Eltsen\Data\SQL\MatchedTimeframes_Corn_Corn_Crude_TenPercent.csv' DELIMITER ',' CSV HEADER;
----------------
...
COPY Common_Models TO 'D:\Sumit\WORK\Eltsen\Data\SQL\Common_Models_Corn_Corn_Crude_TenPercent.csv'
...
CREATE TABLE VAR_GBM
AS
SELECT distinct model, variables FROM models_data;

DROP TABLE IF EXISTS mdl_cmprsn_VG;
CREATE TABLE mdl_cmprsn_VG
AS
SELECT a.*, b.model AS VAR_GBM
FROM 
mdl_cmprsn AS a
INNER JOIN
VAR_GBM AS b
