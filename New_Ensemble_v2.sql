...
DELETE FROM MTF_Details where knar > 20;
...
-- rankd_dtls + fym   --> MTF_Details --> MTF_Dtls_rnk2
-- Selecting only the top 10

DROP TABLE IF EXISTS MTF_Dtls_rnk2;  -- Models are ranked and lower ranks are removed #Models Ranked
CREATE TABLE MTF_Dtls_rnk2
AS
SELECT fym, model, variables, actual_price, forecast,
RANK() OVER(
	PARTITION BY fym
	ORDER BY ape
) knar2
FROM MTF_Details
;
DELETE FROM MTF_Dtls_rnk2 where knar2 > 10;  -- Culled here 
SELECT * FROM MTF_Dtls_rnk2;
...
--********************************************************************************************************
-- Additional Ranking based on APE
-- rankd_dtls + fym   --> MTF_Details --> MTF_Dtls_rnk2 --> MTF_Details_rnk_aap
-- Selecting only the top 10
--********************************************************************************************************
